...
export default {
  /*
   * Terra.js Transport Wrapper
   *
   * Wraps an underlying Terra's provider's RPC transport methods (send/sendAsync)
   * for Houston-specific purposes, mainly for logging / request verbosity.
   */
   ...
   *
   * Used to wrap underlying terra.js behavior before/after sending request
   * payloads to the RPC.
   *
